...
<html>
    <head>
        <title>AgendaRS - [Tipo (Contato)]</title>
        <meta name="generator" http-equiv="content-type" content="text/html">
        <link rel="stylesheet" type="text/css" href="style.css">
    </head>
    <body>
        <table class="bd" width="100%"><tr><td class="hr"><h2>AgendaRS - [Tipo (Contato)]</h2></td></tr></table>
        <table width="100%">
            <tr>
...
function select() {
        ...
        <table class="bd" border="0" cellspacing="1" cellpadding="4">
            <tr>
                ...
                <td><select name="filter_field">
                        ...
                        <option value="<?php echo "codigoTipoContato" ?>"<?php
    if ($filterfield == "codigoTipoContato") {
        echo "selected";
    }
    ?>><?php echo htmlspecialchars("Codigo") ?></option>
            ...
            <tr>
                ...
                <td><a href="tipocontato.php?a=reset">Limpar Filtro</a></td>
            </tr>
        </table>
    </form>
    <hr size="1" noshade>
    ...
    <table class="tbl" border="0" cellspacing="1" cellpadding="5"width="100%">
        <tr>
            ...
            <td class="hr">&nbsp;</td>
            <td class="hr">&nbsp;</td>
            <td class="hr"><a class="hr" href="tipocontato.php?order=<?php echo "codigoTipoContato" ?>&type=<?php echo $ordtypestr ?>"><?php echo htmlspecialchars("Codigo") ?></a></td>
            <td class="hr"><a class="hr" href="tipocontato.php?order=<?php echo "descricao" ?>&type=<?php echo $ordtypestr ?>"><?php echo htmlspecialchars("Descricao") ?></a></td>
        </tr>
        <?php
        for ($i = $startrec; $i < $reccount; $i++) {
            ...
            ?>
            <tr>
                <td class="<?php echo $style ?>"><a href="tipocontato.php?a=view&recid=<?php echo $i ?>">Ver</a></td>
                <td class="<?php echo $style ?>"><a href="tipocontato.php?a=edit&recid=<?php echo $i ?>">Editar</a></td>
                <td class="<?php echo $style ?>"><a href="tipocontato.php?a=del&recid=<?php echo $i ?>">Excluir</a></td>
                <td class="<?php echo $style ?>"><?php echo htmlspecialchars($row["codigoTipoContato"]) ?></td>
...
function showrow($row, $recid) {
    ...
    <table class="tbl" border="0" cellspacing="1" cellpadding="5"width="50%">
        <tr>
            ...
            <td class="dr"><?php echo htmlspecialchars($row["codigoTipoContato"]) ?></td>
        </tr>
        <tr>
...
function showpagenav($page, $pagecount) {
    ...
    <table class="bd" border="0" cellspacing="1" cellpadding="4">
        <tr>
            <td><a href="tipocontato.php?a=add">Inserir Registro</a>&nbsp;</td>
            <?php if ($page > 1) { ?>
                <td><a href="tipocontato.php?page=<?php echo $page - 1 ?>">&lt;&lt;&nbsp;Anterior</a>&nbsp;</td>
            <?php } ?>
            <?php
            global $pagerange;
                ...
                for ($i = 1; $i < $rangecount + 1; $i++) {
                    ...
                    if ((($page >= $startpage) && ($page <= ($i * $pagerange)))) {
                        for ($j = $startpage; $j < $count + 1; $j++) {
                            ...
                            <?php } else { ?>
                                <td><a href="tipocontato.php?page=<?php echo $j ?>"><?php echo $j ?></a></td>
                            <?php
                            }
                        }
                    } else {
                        ?>
                        <td><a href="tipocontato.php?page=<?php echo $startpage ?>"><?php echo $startpage . "..." . $count ?></a></td>
            <?php
            }
        }
    }
    ...
    <?php if ($page < $pagecount) { ?>
                <td>&nbsp;<a href="tipocontato.php?page=<?php echo $page + 1 ?>">Pr�ximo&nbsp;&gt;&gt;</a>&nbsp;</td>
    <?php } ?>
        </tr>
    </table>
        <?php } ?>
    ...
    <table class="bd" border="0" cellspacing="1" cellpadding="4">
        <tr>
            <td><a href="tipocontato.php">P�gina Inicial</a></td>
    <?php if ($recid > 0) { ?>
                <td><a href="tipocontato.php?a=<?php echo $a ?>&recid=<?php echo $recid - 1 ?>">Registro Anterior</a></td>
    <?php } if ($recid < $count - 1) { ?>
                <td><a href="tipocontato.php?a=<?php echo $a ?>&recid=<?php echo $recid + 1 ?>">Pr�ximo Registro</a></td>
    <?php } ?>
        </tr>
    </table>
    <hr size="1" noshade>
...
function addrec() {
    ...
    <hr size="1" noshade>
    <form enctype="multipart/form-data" action="tipocontato.php" method="post">
...
function viewrec($recid) {
    ...
    <table class="bd" border="0" cellspacing="1" cellpadding="4">
        <tr>
            <td><a href="tipocontato.php?a=add">Inserir Registro</a></td>
            <td><a href="tipocontato.php?a=edit&recid=<?php echo $recid ?>">Editar Registro</a></td>
            <td><a href="tipocontato.php?a=del&recid=<?php echo $recid ?>">Excluir Registro</a></td>
        </tr>
    </table>
    <?php
    mysqli_free_result($res);
...
function sql_insert() {
    ...
    $sql = "insert into `tipocontato` (`descricao`) values (" . sqlvalue(@$_POST["descricao"], true) . ")";
...
function sql_update() {
    ...
    $sql = "update `tipocontato` set `descricao`=" . sqlvalue(@$_POST["descricao"], true) . " where " . primarykeycondition();
    mysqli_query($conn, $sql) or die(mysqli_error());
}
...
function sql_delete() {
    ...
    $sql = "delete from `tipocontato` where " . primarykeycondition();
    mysqli_query($conn, $sql) or die(mysqli_error());
}
