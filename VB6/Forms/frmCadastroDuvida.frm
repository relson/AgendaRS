...
Begin VB.Form frmCadastroDuvida 
   ...
   ClientTop       =   435
   ClientWidth     =   8175
   Icon            =   "frmCadastroDuvida.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin VB.ComboBox cboStatus 
      Height          =   315
      ItemData        =   "frmCadastroDuvida.frx":0442
      Left            =   4230
      List            =   "frmCadastroDuvida.frx":0455
      TabIndex        =   6
      Top             =   270
      Width           =   1965
   End
   ...
   End
End
Attribute VB_Name = "frmCadastroDuvida"
