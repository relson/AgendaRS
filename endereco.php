...
<?php } ?>
    ...
    <?php if ($page < $pagecount) { ?>
                <td>&nbsp;<a href="endereco.php?page=<?php echo $page + 1 ?>">Pr�ximo&nbsp;&gt;&gt;</a>&nbsp;</td>
    <?php } ?>
        </tr>
    </table>
        <?php } ?>
    ...
    <table class="bd" border="0" cellspacing="1" cellpadding="4">
        <tr>
            <td><a href="endereco.php">P�gina Inicial</a></td>
    <?php if ($recid > 0) { ?>
                <td><a href="endereco.php?a=<?php echo $a ?>&recid=<?php echo $recid - 1 ?>">Registro Anterior</a></td>
    <?php } if ($recid < $count - 1) { ?>
                <td><a href="endereco.php?a=<?php echo $a ?>&recid=<?php echo $recid + 1 ?>">Pr�ximo Registro</a></td>
    <?php } ?>
        </tr>
    </table>
    <hr size="1" noshade>
