...
<html>
    <head>
        <title>AgendaRS - [Tarefa (Status)]</title>
        <meta name="generator" http-equiv="content-type" content="text/html">
        <link rel="stylesheet" type="text/css" href="style.css">
    </head>
    <body>
        <table class="bd" width="100%"><tr><td class="hr"><h2>AgendaRS - [Tarefa (Status)]</h2></td></tr></table>
        <table width="100%">
            <tr>
...
function select() {
        ...
        <table class="bd" border="0" cellspacing="1" cellpadding="4">
            <tr>
                ...
                <td><select name="filter_field">
                        ...
                        <option value="<?php echo "codigoTarefaStatus" ?>"<?php
    if ($filterfield == "codigoTarefaStatus") {
        echo "selected";
    }
    ...
    ?>><?php echo htmlspecialchars("Descricao") ?></option>
            ...
            <tr>
                ...
                <td><a href="tarefastatus.php?a=reset">Limpar Filtro</a></td>
            </tr>
        </table>
    </form>
    <hr size="1" noshade>
    ...
    <table class="tbl" border="0" cellspacing="1" cellpadding="5"width="100%">
        <tr>
            ...
            <td class="hr">&nbsp;</td>
            <td class="hr">&nbsp;</td>
            <td class="hr"><a class="hr" href="tarefastatus.php?order=<?php echo "codigoTarefaStatus" ?>&type=<?php echo $ordtypestr ?>"><?php echo htmlspecialchars("Codigo") ?></a></td>
            <td class="hr"><a class="hr" href="tarefastatus.php?order=<?php echo "descricao" ?>&type=<?php echo $ordtypestr ?>"><?php echo htmlspecialchars("Descricao") ?></a></td>
        </tr>
        <?php
        for ($i = $startrec; $i < $reccount; $i++) {
            ...
            ?>
            <tr>
                <td class="<?php echo $style ?>"><a href="tarefastatus.php?a=view&recid=<?php echo $i ?>">Ver</a></td>
                <td class="<?php echo $style ?>"><a href="tarefastatus.php?a=edit&recid=<?php echo $i ?>">Editar</a></td>
                <td class="<?php echo $style ?>"><a href="tarefastatus.php?a=del&recid=<?php echo $i ?>">Excluir</a></td>
                <td class="<?php echo $style ?>"><?php echo htmlspecialchars($row["codigoTarefaStatus"]) ?></td>
...
function showrow($row, $recid) {
    ...
    <table class="tbl" border="0" cellspacing="1" cellpadding="5"width="50%">
        <tr>
            ...
            <td class="dr"><?php echo htmlspecialchars($row["codigoTarefaStatus"]) ?></td>
        </tr>
        <tr>
...
function showpagenav($page, $pagecount) {
    ...
    <table class="bd" border="0" cellspacing="1" cellpadding="4">
        <tr>
            <td><a href="tarefastatus.php?a=add">Inserir Registro</a>&nbsp;</td>
            <?php if ($page > 1) { ?>
                <td><a href="tarefastatus.php?page=<?php echo $page - 1 ?>">&lt;&lt;&nbsp;Anterior</a>&nbsp;</td>
            <?php } ?>
            <?php
            global $pagerange;
                ...
                for ($i = 1; $i < $rangecount + 1; $i++) {
                    ...
                    if ((($page >= $startpage) && ($page <= ($i * $pagerange)))) {
                        for ($j = $startpage; $j < $count + 1; $j++) {
                            ...
                            <?php } else { ?>
                                <td><a href="tarefastatus.php?page=<?php echo $j ?>"><?php echo $j ?></a></td>
                                <?php
                            }
                        }
                    } else {
                        ?>
                        <td><a href="tarefastatus.php?page=<?php echo $startpage ?>"><?php echo $startpage . "..." . $count ?></a></td>
                        <?php
                    }
                }
            }
            ...
            <?php if ($page < $pagecount) { ?>
                <td>&nbsp;<a href="tarefastatus.php?page=<?php echo $page + 1 ?>">Pr�ximo&nbsp;&gt;&gt;</a>&nbsp;</td>
            <?php } ?>
        </tr>
    </table>
<?php } ?>
...
function showrecnav($a, $recid, $count) {
    ...
    <table class="bd" border="0" cellspacing="1" cellpadding="4">
        <tr>
            <td><a href="tarefastatus.php">P�gina Inicial</a></td>
            <?php if ($recid > 0) { ?>
                <td><a href="tarefastatus.php?a=<?php echo $a ?>&recid=<?php echo $recid - 1 ?>">Registro Anterior</a></td>
            <?php } if ($recid < $count - 1) { ?>
                <td><a href="tarefastatus.php?a=<?php echo $a ?>&recid=<?php echo $recid + 1 ?>">Pr�ximo Registro</a></td>
            <?php } ?>
        </tr>
    </table>
    <hr size="1" noshade>
...
function addrec() {
    ...
    <hr size="1" noshade>
    <form enctype="multipart/form-data" action="tarefastatus.php" method="post">
...
function viewrec($recid) {
    ...
    <table class="bd" border="0" cellspacing="1" cellpadding="4">
        <tr>
            <td><a href="tarefastatus.php?a=add">Inserir Registro</a></td>
            <td><a href="tarefastatus.php?a=edit&recid=<?php echo $recid ?>">Editar Registro</a></td>
            <td><a href="tarefastatus.php?a=del&recid=<?php echo $recid ?>">Excluir Registro</a></td>
        </tr>
    </table>
    <?php
...
function editrec($recid) {
    ...
    <form enctype="multipart/form-data" action="tarefastatus.php" method="post">
        ...
        <input type="hidden" name="xcodigoTarefaStatus" value="<?php echo $row["codigoTarefaStatus"] ?>">
...
function sql_select() {
    ...
    if (isset($filterstr) && $filterstr != '' && isset($filterfield) && $filterfield != '') {
        ...
        $sql .= " where (`codigoTarefaStatus` like '" . $filterstr . "') or (`descricao` like '" . $filterstr . "')";
    }
...
function sql_getrecordcount() {
    ...
    if (!$wholeonly && isset($wholeonly) && $filterstr != '')
        $filterstr = "%" . $filterstr . "%";
    $sql = "SELECT COUNT(*) FROM `tarefastatus`";
    if (isset($filterstr) && $filterstr != '' && isset($filterfield) && $filterfield != '') {
        $sql .= " where " . sqlstr($filterfield) . " like '" . $filterstr . "'";
    } elseif (isset($filterstr) && $filterstr != '') {
        $sql .= " where (`codigoTarefaStatus` like '" . $filterstr . "') or (`descricao` like '" . $filterstr . "')";
...
function sql_insert() {
    ...
    $sql = "insert into `tarefastatus` (`descricao`) values (" . sqlvalue(@$_POST["descricao"], true) . ")";
...
function sql_update() {
    ...
    $sql = "update `tarefastatus` set `descricao`=" . sqlvalue(@$_POST["descricao"], true) . " where " . primarykeycondition();
    mysql_query($sql, $conn) or die(mysql_error());
}
...
function sql_delete() {
    ...
    $sql = "delete from `tarefastatus` where " . primarykeycondition();
    mysql_query($sql, $conn) or die(mysql_error());
}
...
function primarykeycondition() {
    global $_POST;
    $pk = "";
    $pk .= "(`codigoTarefaStatus`";
    if (@$_POST["xcodigoTarefaStatus"] == "") {
        $pk .= " IS NULL";
    } else {
        $pk .= " = " . sqlvalue(@$_POST["xcodigoTarefaStatus"], false);
    };
    $pk .= ")";
    return $pk;
}
